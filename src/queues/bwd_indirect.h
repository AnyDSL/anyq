...
template struct BWDIndexQueueIndirect<1000>;
template struct BWDIndexQueueIndirect<10000>;
template struct BWDIndexQueueIndirect<100000>;
template struct BWDIndexQueueIndirect<1000000>;
